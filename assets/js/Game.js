class Game {
  ...
  initGameObjects() {
    ...
    this.pig2 = new Pig(new Point(400, 200));
    // this.pig3 = new Pig(new Point(320, GROUND_Y-4 * PIG_RADIUS));
    this.block2 = new Obstacle(new Point(400, 300), BLOCK_WIDTH, BLOCK_HEIGHT);
    ...
    this.block = new Obstacle(new Point(400, 450), BLOCK_WIDTH, BLOCK_HEIGHT);
