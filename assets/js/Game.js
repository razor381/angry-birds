class Game {
  ...
  initGameObjects() {
    ...
    this.block2 = new Obstacle(new Point(500, GROUND_Y - 1 * BLOCK_HEIGHT), BLOCK_WIDTH, BLOCK_HEIGHT);
    ...
    this.block = new Obstacle(new Point(500, GROUND_Y - 3.2 * BLOCK_HEIGHT), BLOCK_WIDTH, BLOCK_HEIGHT);
